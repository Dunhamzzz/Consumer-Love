...
<dl>
	...
	<dd>N/A in beta</dd>
	<dt>Users</dt>
	<dd><?php echo $this->Html->link($product['Product']['inventory_count'],
		array('controller' => 'products', 'action' => 'users', 'productSlug' => $product['Product']['slug']),
		array('class' => 'num-products'));?>
	</dd>
	<dt>Categories</dt>
