<li id="post-<?php echo $post['Post']['id']; ?>" class="
    <?php 
    
    if (isset($userData) && $userData['id'] == $post['Author']['id']) {
        echo 'mine '; 
    }
    ...
    <?php if (isset($userData) && $userData['id'] == $post['Author']['id'] || (isset($isAdmin) && $isAdmin == true)): ?>
        <div class="post-options">
            <?php
            echo $this->Html->link('Edit', array('controller' => 'posts', 'action' => 'edit', $post['Post']['id']), array('class' => 'edit-post', ' title' => 'edit', 'data-id' => $post['Post']['id'])
            );
            ?>
        </div>
    <?php endif; ?>
