 ...
 * @var array
 */
	public $fixtures = array('app.thread', 'app.post', 'app.user', 'app.comment', 'app.inventory', 'app.product', 'app.feed', 'app.news', 'app.category', 'app.categories_product', 'app.report');
