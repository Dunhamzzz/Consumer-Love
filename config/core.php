 ...
 */
	Configure::write('Session.cookie', 'clove');
 ...
 */
	Configure::write('Security.salt', 'ASODKEPTANSdiandaDSniansdubcdotijgorjfaSFothjiadnljasASDaisdhuisgsdkfhjoajRTOifjsdlofhuaczioslijglkm');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '315153781379817491971891549815451791371978137952792197137139713978');
 ...
 *
	Cache::config('default', array(
	 	...
	 	'duration'=> 3600,
	 	'probability'=> 100,
	 	'prefix' => Inflector::slug(APP_DIR) . '_', //  prefix every cache file with this string
	  	'servers' => array(
