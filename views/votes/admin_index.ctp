<div class="votes index">
	...
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $this->Html->link($vote['Product']['name'], array('controller' => 'products', 'action' => 'view', $vote['Product']['id'])); ?>
		</td>
		<td><?php echo $vote['Vote']['score']; ?>&nbsp;</td>
		<td><?php echo $vote['Vote']['comment']; ?>&nbsp;</td>
