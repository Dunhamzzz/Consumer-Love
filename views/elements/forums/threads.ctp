	...
	<li title="<?php echo $thread['Post'][0]['content']; ?>">
		<span class="thread-info">
			<span class="thread-link">
				<?php echo $this->Html->link($thread['Thread']['title'], array(
				'controller' => 'threads',
				'action' => 'view',
			...
			<span class="thread-meta">
				Posted by <?php echo $this->Love->userLink($thread['User']); ?> <?php echo $this->Time->timeAgoInWords($thread['Thread']['created']); ?>
			</span>
		</span>
